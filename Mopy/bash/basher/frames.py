...
class DocBrowser(wx.Frame):
    ...
    def __init__(self,modName=None):
        ...
        wx.Frame.__init__(self, Link.Frame, wx.ID_ANY, _(u'Doc Browser'), pos, size,
...
class ModChecker(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.Frame.__init__(self, Link.Frame, wx.ID_ANY, _(u'Mod Checker'), pos, size,
            style=wx.DEFAULT_FRAME_STYLE)
        self.SetBackgroundColour(wx.NullColour)
        self.SetSizeHints(250,250)
        ...
        self.gShowModList.SetValue(bosh.settings.get('bash.modChecker.showModList',False))
        self.gShowNotes.SetValue(bosh.settings.get('bash.modChecker.showNotes',True))
        self.gShowConfig.SetValue(bosh.settings.get('bash.modChecker.showConfig',True))
        self.gShowSuggest.SetValue(bosh.settings.get('bash.modChecker.showSuggest',True))
        self.gShowCRC.SetValue(bosh.settings.get('bash.modChecker.showCRC',False))
        self.gShowVersion.SetValue(bosh.settings.get('bash.modChecker.showVersion',True))
        #--Events
    ...
    def CheckMods(self,event=None):
        """Do mod check."""
        bosh.settings['bash.modChecker.showModList'] = self.gShowModList.GetValue()
        bosh.settings['bash.modChecker.showRuleSets'] = self.gShowRuleSets.GetValue()
        ...
        bosh.settings['bash.modChecker.showConfig'] = self.gShowConfig.GetValue()
        bosh.settings['bash.modChecker.showSuggest'] = self.gShowSuggest.GetValue()
        bosh.settings['bash.modChecker.showCRC'] = self.gShowCRC.GetValue()
        bosh.settings['bash.modChecker.showVersion'] = self.gShowVersion.GetValue()
